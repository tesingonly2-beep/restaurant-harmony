...
const plans = [
  { name: "Basic", price: "₹3,920", subs: 642, features: ["1 branch", "5 users", "1k orders/mo", "Email support"] },
  { name: "Pro", price: "₹19,920", subs: 528, features: ["5 branches", "30 users", "Unlimited orders", "KDS + Inventory", "Priority support"], featured: true },
  { name: "Enterprise", price: "₹71,920", subs: 114, features: ["Unlimited branches", "Unlimited users", "Custom integrations", "SLA + Dedicated CSM"] },
];

const invoices = [
  { id: "INV-10482", restaurant: "Bombay Bistro", amount: "₹71,920", status: "Paid", date: "Apr 28, 2026" },
  { id: "INV-10481", restaurant: "The Spice Route", amount: "₹19,920", status: "Paid", date: "Apr 27, 2026" },
  { id: "INV-10480", restaurant: "Naan Stop", amount: "₹3,920", status: "Failed", date: "Apr 27, 2026" },
  { id: "INV-10479", restaurant: "Royal Thali", amount: "₹19,920", status: "Paid", date: "Apr 26, 2026" },
  { id: "INV-10478", restaurant: "Curry Kitchen", amount: "₹0", status: "Trial", date: "Apr 25, 2026" },
];
...
function BillingPage() {
  return (
    <div className="space-y-6">
      ...
      <StatGrid stats={[
        { label: "MRR", value: "₹1.19 Cr", tone: "primary" },
        ...
        {plans.map((p) => (
          <Card key={p.name} className={`p-6 border-border/60 ${p.featured ? "ring-2 ring-primary shadow-[var(--shadow-warm)]" : ""}`}>
            ...
            <Button
              ...
              onClick={() => notify(`Editing ${p.name} plan`)}
            >
              Edit Plan
            </Button>
          </Card>
